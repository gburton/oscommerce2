...
*/
  ...
  class cm_attributes {
    ...
    function install() {
      ...
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Sort Order', 'MODULE_CONTENT_ATTRIBUTES_SORT_ORDER', '0', 'Sort order of display. Lowest is displayed first.', '6', '0', now())");
    }
    ...
    function keys() {
      return array('MODULE_CONTENT_ATTRIBUTES_STATUS', 'MODULE_CONTENT_ATTRIBUTES_TYPE', 'MODULE_CONTENT_ATTRIBUTES_SORT_ORDER');
    }
  }
?>