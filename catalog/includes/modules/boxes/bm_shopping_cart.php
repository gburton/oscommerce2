  ...
  class bm_shopping_cart {
    ...
    function execute() {
      ...
      $data = '<div class="panel panel-default">' .
              '  <div class="panel-heading"><a href="' . tep_href_link(FILENAME_SHOPPING_CART, '', 'SSL') . '"><i class="glyphicon glyphicon glyphicon-shopping-cart"></i> ' . MODULE_BOXES_SHOPPING_CART_BOX_TITLE . '</a></div>' .
